...
@Entity(tableName = "competition_list")
public class Competition {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("area", area).append("name", name).append("code", code).append("emblemUrl", emblemUrl).append("plan", plan).append("currentSeason", currentSeason).append("numberOfAvailableSeasons", numberOfAvailableSeasons).append("lastUpdated", lastUpdated).toString();
    }
